...
description: "A reflective leadership essay on the first year in an HOD role, covering uncertainty, communication, mentorship, narrative ownership, and sustainable team leadership."
summary: "This post reflects on one year in leadership, tracing lessons about uncertainty, difficult conversations, team silence, mentorship, decision-making, and the cost of trying to lead on empty."
categories: ["Life", "Mentorship", "Leadership"]
tags: ["Leadership", "Mentorship", "Career Growth", "Team Culture", "Management", "Reflection", "HOD"]
image: mentorship-cover.jpg
hero: mentorship-cover.jpg
canonical: "https://deploy-preview-10--innova-writers-club.netlify.app/one-year-in-hod/"
menu:
  sidebar:
    name: One Year in HOD
    identifier: one-year-in-hod
    parent: mentorship
---

> Originally published at [Innova Writers Club](https://deploy-preview-10--innova-writers-club.netlify.app/one-year-in-hod/).
...
I expected clarity before I acted - full understanding, buy-in from everyone, a team that understood *why* before I moved. That almost never happened. Watching my fellow leads and mentors operate through genuinely messy situations, I noticed they rarely waited for the room to catch up before deciding. Oftentimes one would gather what they could, make the call, and let understanding follow - usually through steady, repeated communication rather than delayed action.
